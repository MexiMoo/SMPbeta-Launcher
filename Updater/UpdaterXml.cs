...
namespace Updater
{
    internal class UpdaterXml
    {
        ...
        internal static UpdaterXml Parse(Uri location, string appID)
        {
            ...
            string url = "", fileName = "", md5 = "", description = "", lauchArgs = "";
            ...
            try
            {
                ...
                lauchArgs = node["launchArgs"].InnerText;

                return new UpdaterXml(version, new Uri(url), fileName, md5, description, lauchArgs);
            }
            catch { return null; }
        }
    }

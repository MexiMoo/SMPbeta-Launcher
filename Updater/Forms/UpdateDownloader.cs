...
namespace Updater
{
    internal partial class UpdateDownloader : Form
    {
        ...
        {
            this.Download_Progress.Value = e.ProgressPercentage;
            this.Lab_Progress.Text = String.Format("Downloaded {0} of {1}", FormatBytes(e.BytesReceived, 1, true), FormatBytes(e.TotalBytesToReceive, 1, true));
        }
        ...
        private void webClient_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            {
                Lab_Progress.Text = "Veryfying Download...";
                Download_Progress.Style = ProgressBarStyle.Marquee;
